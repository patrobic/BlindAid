...
namespace Vision
{
  namespace TrafficLight
  {
    ...
    void BlobDetector::MaskColors()
    {
      ...
      for (int i = 1; i < 3; ++i)
        inRange((*_input->GetHsvImage())(Rect(0, 0, redRegionUpper.cols, (int)(redRegionUpper.rows*_params->GetUpperRegionToAnalyze()))), _params->GetColorRange(i, 0), _params->GetColorRange(i, 1), _blobMask[i]);
